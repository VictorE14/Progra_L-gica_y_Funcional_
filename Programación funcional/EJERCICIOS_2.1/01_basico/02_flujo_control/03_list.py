...
mensaje = ["C", "o", "d", "i", "g", "o", " ", "s", "e", "c", "r", "e", "t", "o"]
secreto = mensaje[7:]  # desde el índice 7 hasta el final
print("Mensaje original:", mensaje)
print("Mensaje secreto:", secreto)
...
print("Lista intercambiada:", numeros)
...
lista_duplicada = lista_original + lista_original
...
centro = len(lista_impar) // 2
elemento_central = lista_impar[centro]
...
primera_mitad_reversa = lista_reversa[:mitad][::-1]
resultado = primera_mitad_reversa + lista_reversa[mitad:]
print("Original:", lista_reversa)
print("Resultado (primera mitad invertida):", resultado)